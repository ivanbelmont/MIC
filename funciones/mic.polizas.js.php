...
if(localStorage.getItem("getValorPoliza")){


var valor = localStorage.getItem("getValorPoliza");
...
var mensajeParam;
 ...
 parametros = {
                ...
                "proceso" : "ZXN0ZWVzdW5saW5rcGFyYW1vc3RyYXJwb2xpemFzZGVsY2xpZW50ZQ",
                "valor" : valor
        };//END PARAMETROS
...
$('#Ym90b25wYXJhaWRlbnRpZmljYXJjbGllbnRlZWRpdGFy').hide();
   ...
   $("#Ym90b25wYXJhaWRlbnRpZmljYXJjbGllbnRlZWRpdGFy").click(function(){
        ...
        var id_int = localStorage.getItem("getValorPoliza");
