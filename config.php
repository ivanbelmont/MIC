...
define( 'DB_USERNAME', 'mic_user');//Usuario de la base de datos
define( 'DB_PASSWORD', 'rNQTWEKsSJeHu24d');//Contraseña de la base de datos
define( 'DB_NAME', 'mic');//Nombre de la base de datos
define('BASE_PATH_ASSETS', $puerto.$CONF.'MicGit/assets/');
define('BASE_PATH_POLIZAS', $puerto.$CONF.'MicGit/pdf/polizas/');
